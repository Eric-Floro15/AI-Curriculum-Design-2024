...
## Run config
- LLM: `LLM: provider=ollama, model=ollama_chat/qwen3:14b, num_ctx=8192 (requested)`
- cases run: 2
- PASS: 0
...
|---|---|---|---|---|
| queens-rag-hit | FAIL | (none detected) | step_callback | 0.7 |
...
```
  ...
  🚀 Crew Execution Started  
   ...
   Crew Execution Started                                                                                                                     
   Name: crew                                                                                                                                 
   ID: 712d9140-d10c-4f40-8c98-73d4a110966c                                                                                                   
  ...
  📋 Task Started  
   ...
   ID: 40ddd6f8-70af-4503-aea3-a301c077761b                                                                                                   
...
```
  ...
  🚀 Crew Execution Started  
   ...
   Crew Execution Started                                                                                                                     
   Name: crew                                                                                                                                 
   ID: 5bfa0541-d317-4e1f-925f-f006043c34be                                                                                                   
  ...
  📋 Task Started  
   ...
   ID: fa9d9ff6-b0f9-484f-8bf6-1bb6035bd497                                                                                                   
